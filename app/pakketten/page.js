...
const CSS = `
  ...
  :root {
    --orange:#FF4D00; --orange-dim:rgba(255,77,0,0.15);
    --dark:#0A0A0A; --dark2:#111; --dark3:#181818; --dark4:#222;
    --text:#F0EEE8; --muted:#888; --muted2:#555;
    --display:'Oswald',Impact,sans-serif; --body:'Barlow Condensed',sans-serif;
  }
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  nav{display:flex;align-items:center;justify-content:space-between;padding:22px 60px;border-bottom:1px solid rgba(255,77,0,0.12);background:rgba(10,10,10,0.97);position:sticky;top:0;z-index:100;backdrop-filter:blur(8px);}
  ...
  .pakket-card.featured:hover{transform:translateY(-8px);box-shadow:0 16px 40px rgba(255,77,0,0.2);}
  ...
  .addon-card:hover{border-color:rgba(255,77,0,0.3);transform:translateY(-3px);}
  ...
  /* FLOAT BUTTON */
  .float-btn{position:fixed;bottom:32px;right:32px;background:var(--orange);color:#000;font-family:var(--body);font-weight:700;font-size:13px;letter-spacing:2px;text-transform:uppercase;padding:14px 24px;text-decoration:none;z-index:999;box-shadow:0 4px 24px rgba(255,77,0,0.4);transition:transform .2s,box-shadow .2s,background .2s;display:flex;align-items:center;gap:8px;}
  .float-btn:hover{transform:translateY(-3px);box-shadow:0 8px 32px rgba(255,77,0,0.55);background:#e64400;}
  ...
  footer{background:var(--dark);border-top:1px solid rgba(255,77,0,0.1);padding:40px 60px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px;}
...
export default function Pakketten() {
  ...
  return (
    <>
      ...
      {/* HERO */}
      <section style={{textAlign:'center', borderBottom:'1px solid rgba(255,77,0,0.1)', paddingBottom:60}}>
        ...
        <div className="fade-in delay-3" style={{fontFamily:'var(--body)', fontSize:13, color:'var(--muted)', letterSpacing:1}}>
          ...
          {packages.map((pkg, i) => (
            <div key={pkg.name} className={`pakket-card fade-in delay-${i+1} ${pkg.popular ? 'featured' : ''}`}>
              ...
              <div style={{display:'flex', alignItems:'flex-end', gap:6, margin:'20px 0 8px'}}>
                <span style={{fontFamily:'var(--display)', fontSize:52, fontWeight:700, color: pkg.popular ? 'var(--orange)' : 'var(--text)', lineHeight:1}}>€{pkg.price}</span>
                <span style={{fontFamily:'var(--body)', fontSize:14, color:'var(--muted)', marginBottom:6}}>/maand</span>
              </div>
      ...
      {/* GROEPEN & BEDRIJVEN */}
      <section style={{padding:'60px 60px', borderTop:'1px solid rgba(255,77,0,0.1)'}}>
        <div style={{maxWidth:1100, margin:'0 auto'}}>
      ...
      {/* CTA */}
      <section className="fade-in" style={{padding:'80px 60px', background:'var(--dark2)', textAlign:'center', borderTop:'1px solid rgba(255,77,0,0.1)'}}>
